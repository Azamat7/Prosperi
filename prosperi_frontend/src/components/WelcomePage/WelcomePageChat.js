  ...
  return (
    <div class="w-screen pt-8 pb-8 px-4 md:px-10 font-primary flex justify-center">
      <div class="flex flex-col relative w-[288px] md:w-[640px] items-center md:items-baseline">
        <div class="w-56 lg:w-72 place-self-start order-1 md:order-1">
          <p class="text-2xl lg:text-[28px] lg:text-4xl font-bold text-left">Chat with a Personal mentor</p>
        </div>
        <div class="w-72 text-left pt-1 order-2 md:order-2">
        ...
        <div class="pt-4 lg:pt-5 order-4 md:order-3">
          <button class="rounded-lg bg-btn-primary text-white h-14 w-72 text-lg font-bold">Get advice</button>
        </div>
